...
|The designated repository administrator |Accepts, denies, or asks for changes to the merge request. The administrator might make small changes, for example, for template conformity, before accepting the merge request.
...
|A designated member of the Documentation Conventions project |Merges the request when it is ready. The administrator might make small changes, for example, for template conformity, before accepting the merge request.
|====
