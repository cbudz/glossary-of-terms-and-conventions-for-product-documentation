...
[NOTE]
====
This procedure requires `git` and `ccutil` to be installed. See https://pantheon-ccstools.itos.redhat.com/help/user-guide/#ccutil-install[Installing ccutil] for details.
====
