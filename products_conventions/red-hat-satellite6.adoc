...
[NOTE]
====
In Red Hat Virtualization the UI use Foreman/Satellite. Use this only when referring directly to the UI element. A bug is open to get this element changed to Satellite. (https://bugzilla.redhat.com/show_bug.cgi?id=1428205[BZ#1428205 Change Foreman/Satellite to Satellite]) 
====
