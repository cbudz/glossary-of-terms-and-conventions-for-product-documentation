...
Always use "Administration Portal", including the capital P. When other departments (or upstream) say "webadmin" or "Administrator portal", this is what they are referring to. 
