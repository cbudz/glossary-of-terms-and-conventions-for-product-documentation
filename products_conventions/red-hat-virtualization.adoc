...
[[gather]]
==== Gather (verb)
*Description*: Use gather when discussing Red Hat Virtualization metrics. Do not use collect. Collect is reserved for discussing the Red Hat Virtualization log collector (ovirt-log-collector).
