...
==== Azure CLI 2.0 (noun)
[[cli]]
*Description*: "Azure CLI 2.0" is a set of open source commands for managing Microsoft Azure platform resources. Typing `azure` at the CLI command prompt lists each of the many Microsoft Azure subcommands. Azure CLI 2.0 is the most current command-line interface and is replacing Microsoft Azure Xplat-CLI.
...
Azure CLI 2.0 is the most current command-line interface and is replacing Xplat-CLI.
