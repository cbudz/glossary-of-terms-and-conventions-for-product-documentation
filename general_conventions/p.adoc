...
[[performance-counter]]
*Description*: A performance counter is an utility for collecting and analyzing performance data. Always use "performance counter" unless referring to a code element named `perfcounter` and as such, mark it up appropriately.
