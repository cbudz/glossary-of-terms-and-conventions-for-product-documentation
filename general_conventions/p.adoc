...
*Description*: Use the following rules to form the plural of this phrase: Use "proofs of concept" when there are multiple proofs but only one concept. Use "proofs of concepts" when there are multiple proofs and multiple concepts.
