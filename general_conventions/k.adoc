...
==== KB (noun)
[[KB]]
*Description*: "KB" is the initialism of kilobyte. One "KB" equals 1024 bytes.
...
==== kB (noun)
[[kB]]
*Description*: "kB" is the initialism of kilobyte. One "kB" equals 1000 bytes.
...
*Description*: "Kernel-based Virtual Machine" is a loadable kernel module that converts the Linux kernel into a bare metal hypervisor. Spell out "Kernel-based Virtual Machine" on first occurrence, and use the initialism "KVM" thereafter. It is an industry standard and a proper noun.
