...
==== tier-1 (adjective)
[[tier-1]]
*Description*: Always hyphenate "tier-1" and indicate the number is numerals. Follow standard capitalization guidelines.
...
==== time to live (noun)
[[time-to-live-n]]
*Description*: "Time to live" should not be capitalized unless you are documenting a GUI field, label, or similar element, in which case you should use the same capitalization. Capitalization at the beginning of a sentence is acceptable.
