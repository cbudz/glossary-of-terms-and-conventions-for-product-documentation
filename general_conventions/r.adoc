...
*Description*: Red Hat's hosted registry for Enterprise-ready containers located
at link:https://access.redhat.com/containers[access.redhat.com/containers]. A
trusted source for secure, certified, and up-to-date container images. Write
this name in full the first time that you use it in a document.
