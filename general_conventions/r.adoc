...
==== RHEL (noun)
[[rhel]]
*Description*: An acronym for Red Hat Enterprise Linux. Previously, we were supposed to expand this acronym every time. After latest discussion, we can use RHEL with caution.
