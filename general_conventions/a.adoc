...
==== agnostic (adjective)
[[agnostic]]
*Description*: "Agnostic" denotes or relates to hardware or software that is compatible with many types of platforms or operating systems. For example, many common file formats (JPEG, MP3, etc.) are platform agnostic. Use "neutral" instead.
