...
==== Guestfish (noun)
[[guestfish]]
*Description*: Guestfish is an interactive shell that supports commands for accessing and modifying virtual disk images used in platform virtualization. The tools can be used for viewing and editing virtual machines (VMs) managed by libvirt.
