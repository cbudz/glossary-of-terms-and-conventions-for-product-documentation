...
==== GAS (noun)
[[gas]]
*Description*: "GAS" is an initialism for "GNU Assembler," the assembler used by the GNU Project. When referring to the program, use "GAS."
...
==== gas (noun)
[[gas-command]]
*Description*: "GAS" is an initialism for "GNU Assembler," the assembler used by the GNU Project. When referring to the command, use `gas`, marked up appropriately.
...
==== GB (noun)
[[gb]]
*Description*: "GB" is an initialism of gigabyte. Use a space between the value and the abbreviation, for example, "a 2 GB file."
...
==== Gbps (noun)
[[gbps]]
*Description*: "Gbps" is an initialism for Gigabits per second, a data transfer speed measurement for high-speed networks such as Gigabit Ethernet. When used to describe data transfer rates, a gigabit equals 1,000,000,000 bits.
...
==== GCC (noun)
[[gcc]]
*Description*: The GNU Compiler Collection ("GCC") is a compiler system produced by the GNU Project supporting various programming languages. When referring to the program, use "GCC."
...
==== gcc (noun)
[[gcc-command]]
*Description*: The GNU Compiler Collection (GCC) is a compiler system produced by the GNU Project supporting various programming languages. When referring to the command, use `gcc`, marked up appropriately. 
...
==== GCJ (noun)
[[gcj]]
*Description*: The GNU Compiler for Java ("GCJ") was a free compiler for the Java programming language and part of the GNU Compiler Collection. As of 2015, there were no new developments announced from "GCJ."" In 2016, "GCJ" was removed from "GCC." When referring to the program, use "GCJ." 
...
*Description*: The GNU Compiler for Java ("GCJ") was a free compiler for the Java programming language and part of the GNU Compiler Collection. As of 2015, there were no new developments announced from "GCJ." In 2016, "GCJ" was removed from "GCC." When referring to the command, use `gcj`, marked up appropriately.
...
==== GDB (noun)
[[gdb]]
*Description*: The GNU Debugger ("GDB"), is the standard debugger for the GNU operating system. It is a portable debugger that runs on many Unix-like systems and works for many programming languages. When referring to the program, use "GDB."
...
==== gdb (noun)
[[gdb-command]]
*Description*: The GNU Debugger ("GDB"), is the standard debugger for the GNU operating system. It is a portable debugger that runs on many Unix-like systems and works for many programming languages. When referring to the command, use `gdb`, marked up appropriately.
...
==== GNU (noun)
[[gnu]]
*Description*: GNU is a recursive initialism for "GNU's Not Unix." "GNU" is a Unix-like, open source operating system. Do not use "Gnu" or "gnu."
...
==== GPL (noun)
[[gpl]]
*Description*: GPL is an initialism for General Public License. Do not use "Gpl" or "gpl."
...
==== GRUB (noun)
[[grub]]
*Description*: "GRUB" is a Linux boot loader and is an acronym for "GRand Unified Bootloader."
