...
==== DNS (noun)
[[dns]]
*Description*: "DNS" is an Initialism for "Domain Name System" or "Domain Name Service," a service that translates domain names into IP addresses and vice versa.
...
[[downstream]]
*Description*: "Downstream" is an adjective that refers to data sent from a network service provider to a customer.
