...
. Make edits in the guide.
    ...
    .. Make the changes. Use the https://gitlab.cee.redhat.com/ccs-internal-documentation/documentation-conventions/blob/master/topics/template.adoc[template] when adding a new entry.
